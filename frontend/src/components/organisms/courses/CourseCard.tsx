...
export default function CourseCard({ type = 'column', containerClassName, course }: CourseCardProps) {
  ...
  return (
    ...
    >
      <Image src={course.thumbnail} alt="course" className="h-[228px] w-full rounded-xl object-cover" />
